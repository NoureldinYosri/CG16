...
function character() {
	...
	var image;
	var theta = vec3(10,90,-30),thetaLoc;
	...
	function quad(a,b,c,d,idx,idx2) {
		...
		for ( var i = 0; i < corners.length; ++i ) {
			...
			points.push(r);
		//	colors.push(color);
			console.log(idx + " " + idx2 + " " + TexCoor[i])
...
//			vTexCoord.push(vec2(0.5 - corners[i][0],0.5 - corners[i][1] ));
	...
	function create_scene() {
		var head = node(0,"head",[0.4,0.03,0,0],0.5,0.5,0.5); //0.1,0.1,0.1
		var torso = node(1,"torso",[0.4,-0.2,0,0],0.1,0.3,0.1);
